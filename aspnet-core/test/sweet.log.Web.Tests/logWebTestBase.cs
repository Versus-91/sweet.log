...
{
    public abstract class logWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static logWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(logWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<logDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<logDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<logDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<logDbContext, Task<T>> func)
        {
            T result;
